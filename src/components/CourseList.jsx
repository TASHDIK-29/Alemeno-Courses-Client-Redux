    ...
    return (
        <div className="bg-gray-100 text-gray-900">
            <div className="container grid grid-cols-12 mx-auto">
                <div className="flex flex-col justify-center col-span-12 align-middle bg-gray-300 bg-no-repeat bg-cover lg:col-span-6 ">
                ...
                <div className="flex flex-col col-span-12 p-6 divide-y lg:col-span-6 lg:p-10 divide-gray-300  h-screen overflow-y-auto">
                    {
                        courses.map(course => (
                            <div key={course._id} className="pt-6 pb-4 space-y-2">
                                ...
                                <Link to={`/course/${course._id}`} rel="noopener noreferrer" href="#" className="inline-flex items-center py-2 space-x-2 text-sm text-violet-600">
                                    <span>Details</span>
